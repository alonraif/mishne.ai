...
SYSTEM = (
    ...
    "it.\n\n"
    "**Offer roughly twice the target duration of material, and rank it.** "
    "This is not a request for a longer cut — a solver downstream picks the "
    "final selection from what you offer, and it can only choose between "
    "things you gave it. Offer exactly the target and you have made every "
    "decision yourself, including the ones about length that the brief "
    "constrains: there is nothing to drop, so a span that runs too long stays "
    "in for want of an alternative.\n\n"
    "Score each span 0-100 for how much it earns its place. Spread the scores "
    "and mean them — the scores are what say which half of your offer is the "
    "cut and which half is the reserve.\n\n"
